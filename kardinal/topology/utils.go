...
func DeepCopyService(src *Service) *Service {
	dst := &Service{}
	unsafeDeepCopy(src, dst)
	return dst
}

func DeepCopyClusterTopology(src *ClusterTopology) *ClusterTopology {
	dst := &ClusterTopology{}
	unsafeDeepCopy(src, dst)
	return dst
}

func DeepCopyIngress(src *Ingress) *Ingress {
	dst := &Ingress{}
	unsafeDeepCopy(src, dst)
	return dst
}

func SPrintJSONClusterTopology(clusterTopology *ClusterTopology) string {
